...
proApp.controller('indexMainCtrl', function($scope, $http, $window) {
    ...
    angular.element(document).ready(function() {
        ...
        $http({
            method: "GET",
            url: "http://" + host + "/shoppingcart/getUserId",
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            }
            ...
            if (loginSuccessResponse.data != "" && loginSuccessResponse.data != "null" && loginSuccessResponse.data != null) {
                ...
                $http({
                    ...
                    var htmlData = '<scan style="color:red">';
                    htmlData += response.data.productList.length;
                    htmlData += '</scan>';
                    document.getElementById("itemsInCart").innerHTML = htmlData;
                }, function myError(response) {
                    $scope.myWelcome = response.statusText;
                });
    ...
    fnViewBagCheckOut = function() {
        ...
        $http({
            ...
            if (loginSuccessResponse.data != "" && loginSuccessResponse.data != "null" && loginSuccessResponse.data != null) {
                ...
                landingUrl = landingUrl + "?productId=1;userId=" + loginSuccessResponse.data;
